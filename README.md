...
- 查看本机 Codex 技能列表
- 默认显示中文分类、中文摘要和使用触发提示
- 搜索技能名称、说明、备注、中文摘要和分类
- 按 Codex、插件、自定义来源筛选
- 点击技能先看中文说明，再查看完整 `SKILL.md`
- 为技能保存中文名称、中文摘要、备注、分类和隐藏状态
- 添加包含 `SKILL.md` 的本地技能目录作为额外扫描来源
- 从公开 GitHub 仓库安装技能，支持 `owner/repo`、仓库 URL、tree 到具体技能目录的 URL
- 显示扫描错误，但不阻断其它技能展示

## 第一版限制

- GitHub 安装只支持公开仓库
- GitHub 安装不会执行仓库里的任何脚本
- 不支持发布技能
